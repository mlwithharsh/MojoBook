...
/**
 * Sidebar Navigation for MojoBook.
 * Provides access to feeds, popular communities (Mojos), and platform info.
 */
export default function Sidebar() {
  return (
    <aside className="w-[280px] hidden lg:block h-[calc(100vh-48px)] sticky top-[48px] overflow-y-auto p-4 bg-[#1A1A1B] text-gray-200 shadow-inner">
      <div className="space-y-4">
        ...
        <div className="pt-4 border-t border-[#343536]">
          <div className="bg-[#272729] p-4 rounded-lg border border-[#343536]">
