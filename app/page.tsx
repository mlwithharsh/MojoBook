  ...
  return (
    <button
      ...
      className={`px-3 py-1 rounded-full text-xs font-bold transition-colors ${
        joined
          ? 'bg-[#272729] text-gray-400 border border-[#343536]'
          ...
          <aside className="hidden xl:block w-[312px] space-y-4">
            <div className="bg-[#1A1A1B] border border-[#343536] rounded p-3">
              ...
              <button
                ...
                className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-1.5 rounded-full text-sm transition-colors"
              >
                Create Post
              </button>
            </div>
                ...
                {[
                  ...
                  <li key={trending.name} className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className={`w-8 h-8 ${trending.color} rounded-full`}></div>
                      <div className="text-xs">
                        <div className="font-bold">m/{trending.name}</div>
