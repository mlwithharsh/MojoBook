            ...
            <div className="bg-[#1A1A1B] border border-[#343536] rounded p-6 mb-6 flex items-start gap-6">
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <button className="bg-yellow-400 text-black px-4 py-1.5 rounded-full font-bold text-sm">Follow</button>
                  <button className="bg-[#272729] border border-[#343536] text-white px-4 py-1.5 rounded-full font-bold text-sm">Message</button>
                </div>
              </div>
            </div>
